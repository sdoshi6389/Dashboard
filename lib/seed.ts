...
export const seedVisionTiles: VisionTile[] = [
  ...
  },
  {
    ...
    category: "Money",
    imageUrl:
      "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=400&fit=crop",
    notes: "",
    createdAt: now,
  },
  {
  ...
  },
  {
    ...
    category: "Other",
    imageUrl:
      "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=400&fit=crop",
    notes: "",
    createdAt: now,
  },
];
...
export const seedReviews: Review[] = [
  {
    ...
    takeaways: ["Systems thinking", "Trade-offs matter"],
    favoriteQuote: "Data is the truth.",
    applyThis: "Document decisions.",
    createdAt: now,
  },
];
...
export const seedReadingLogs: ReadingLog[] = [
  {
    ...
    pagesRead: 18,
    upToPage: 18,
    notes: "Good opening ideas on focus.",
    createdAt: now,
  },
];
...
export const seedFragrances: Fragrance[] = [
  {
    ...
    name: "Bleu de Chanel",
    brand: "Chanel",
    notesTop: ["Citrus", "Mint"],
    notesMid: ["Ginger", "Iso E Super"],
    notesBase: ["Sandalwood", "Cedar"],
    season: "spring",
    seasons: ["spring", "summer", "fall", "winter"],
    vibeTags: ["fresh", "versatile"],
    longevity: 4,
    projection: 3,
    sampled: true,
    wouldBuy: true,
  ...
  },
  {
    ...
    notesTop: ["Ambrette"],
    notesMid: ["Sage"],
    notesBase: ["Grapefruit"],
    season: "summer",
    seasons: ["summer"],
    vibeTags: ["clean", "minimal"],
    longevity: 2,
    projection: 2,
    sampled: false,
    wouldBuy: false,
...
export const seedWorkouts: WorkoutPlan[] = [];
